...
//	OKMsg = "200" //成功返回消息
//
//	LocalSavePathOfGoodsPictures      = "/home/project/test03/src/static/goods/pictures/"      //商品图片保存路径
//	LocalSavePathOfUserPhotos         = "/home/project/test03/src/static/user/photos/"         //用户头像保存地址
//	LocalSavePathOfEvaluationPictures = "/home/project/test03/src/static/evaluation/pictures/" //评价图片保存地址
//
//	OrderIdLeftShiftNumber = 32 //生成全局OrderId左移位数
//	GoodsIdLeftShiftNumber = 20 //生成全局GoodsId左移位数
//
